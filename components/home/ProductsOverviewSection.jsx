...
export default function ProductsOverviewSection() {
  return (
    <div className="relative overflow-hidden bg-[rgba(18,18,18,1)]">
      <div className="relative overflow-hidden bg-[rgba(18,18,18,1)] px-4 sm:px-6 md:px-10 lg:px-16 py-12 sm:py-20 md:py-32">
        ...
        <div className="mx-auto max-w-6xl relative z-10">
          ...
          {/* Main heading */}
          <h2 className="mb-8 sm:mb-12 md:mb-14 text-left">
            <span
              style={{
                ...headingBase,
                background:
            ...
            {products.map((product) => (
              <article key={product.name} className="flex flex-col gap-3">
                <div className="mb-2 flex items-start gap-4">
                  ...
                  <h3 className="mt-4" style={monoSubheadingStyle}>{product.name}</h3>
                </div>
