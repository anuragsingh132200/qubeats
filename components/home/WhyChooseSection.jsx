  ...
  return (
    <div className="relative overflow-hidden bg-[rgba(18,18,18,1)] px-4 sm:px-6 md:px-10 lg:px-16 py-8 sm:py-12 md:py-16">
      ...
      <div className="relative z-10 mx-4 sm:mx-6 md:mx-10 px-4 sm:px-6 md:px-4">
        ...
        {/* Top label */}
        <p className="mb-4 sm:mb-6 ml-4 sm:ml-6 md:ml-8 font-regular font-weight-200 uppercase text-[rgba(243,243,243,0.8)] text-lg sm:text-xl md:text-[24px] font-['Courier_New']">
          Why Qubeats
        </p>
        ...
        <div className="relative overflow-hidden min-h-[500px] sm:min-h-[580px] md:h-[630px] bg-[rgba(192,192,192,1)] px-4 sm:px-6 py-6 sm:py-8 md:px-8 md:py-10 md:pt-15 md:pb-10">
          ...
          <div className="pointer-events-none absolute right-80 -top-20 hidden lg:block">
            <Image
